...
const Answer = ({ answer, selectedAns, handleSelectAnswer, index, answerLabels }) => {
  ...
  return (
    <li className='w-full'>
      ...
      >
        <span className={cn(isSelected ? 'bg-white text-black' : 'bg-gray-200  group-hover:bg-purple group-hover:text-black', 'text-lg rounded-lg py-2 px-4')}>{answerLabels[index]}</span>
